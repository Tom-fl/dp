 ...
 * @LastEditTime: 2023-03-21 10:41:01
 * @Email: Tom
 * @FilePath: \vue-element-admin-i18n\src\views\windPower\child\ChildMap.vue
 * @Environment: Win 11
 * @Description:
-->
<template>
    ...
    init() {
      ...
      this.commonData.map((item, index) => {
        ...
        markersList.push({
          ...
          level: item.level,
          icon: new AMap.Icon({
            size: new AMap.Size(this.$chartsSize(50), this.$chartsSize(50)),
            image: require(`@/assets/img/windPower/map/${item.icon}.svg`),
            imageSize: new AMap.Size(this.$chartsSize(50), this.$chartsSize(50))
          })
        })
